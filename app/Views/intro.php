...
<section>
	...
	<p>The page you are looking at is the portal for a simple login system using CodeIgniter.</p>

	<p>If you would like to login into the system type:</p>

	<pre><code>http://(website.com)/login</code></pre>
